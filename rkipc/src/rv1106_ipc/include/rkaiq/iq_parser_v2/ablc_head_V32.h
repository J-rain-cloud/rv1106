...
typedef struct Blc_ob_dataV32_s {
    ...
    float* ISO;
    int ISO_len;
    // M4_ARRAY_DESC("isp_ob_Offset", "f32", M4_SIZE(1,100), M4_RANGE(0,4095), "0",M4_DIGIT(4), M4_DYNAMIC(1))
    float* isp_ob_Offset;
    int isp_ob_Offset_len;
    // M4_ARRAY_DESC("isp_ob_preDgain", "f32", M4_SIZE(1,100), M4_RANGE(0,4095), "0",M4_DIGIT(4), M4_DYNAMIC(1))
